			...
			<div class="time-container col-sm-10 ">
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place1" name="${listmovies.get(0).getId()}" value="0" onclick="showviewee(this)">
				...
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place2" name="${listmovies.get(0).getId()}" value="1" onclick="showviewee(this)">
				...
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place3" name="${listmovies.get(0).getId()}" value="2" onclick="showviewee(this)">
				...
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place4" name="${listmovies.get(0).getId()}" value="3" onclick="showviewee(this)">
				...
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place5" name="${listmovies.get(0).getId()}" value="4" onclick="showviewee(this)">
				...
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place6" name="${listmovies.get(0).getId()}" value="5" onclick="showviewee(this)">
				...
				<div class="day-time">
					<label style="cursor: pointer;"> <input type="button"
						hidden="hidden" id="place7" name="${listmovies.get(0).getId()}" value="6" onclick="showviewee(this)">
			...
			<c:if test="${listmovies != null}">
				<c:forEach items="${listmovies}" var="list">
					<div class="calendar-tag">
						...
						<div class="movie-img">
							<img class="img" src="data:image/jpg;base64,${linkanh.get(count).getImgString()}" alt="">
						</div>
...
<script>
	var a = '';
	function showviewee(e) {
		console.log(e)
		$.ajax({
			url : "/FinalMovieProject/viewshowtime4",
			type : "POST",
			data : {
				place : e.value,
				idmovie: e.name

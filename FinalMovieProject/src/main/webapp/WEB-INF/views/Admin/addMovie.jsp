...
<%-- 	<% Movie data = (Movie) request.getAttribute("list"); %> --%>
		<div class="editmovie">
			<form class="edit" action="${pageContext.request.contextPath}/admin/movie/add" method="post" enctype="multipart/form-data">
				...
				<div class="form-group body">
					<div class="form-group edit-row">
						<div class="form-group edit-row-right">
							<label>Tên phim:</label> <input class="edit-row-text" name="name" " type="text" required></input>
							
						</div>
						<div class="form-group edit-row-left">
							<label>Thể loại: </label> <select class="edit-row-check"
								id="typemovie" multiple="multiple"  name="movieTypes1"  required >
					...
					<div class="form-group edit-row">
						<div class="form-group edit-row-right">
							<label>Thời lượng:</label> <input class="edit-row-text"
								type="text" name="time" value=""  required></input>
						</div>
						<div class="form-group edit-row-left">
							<label>Quốc gia: </label> <select class="edit-row-checkcountry" name="country" id="country"  required>
					...
					<div class="form-group edit-row">
						<div class="form-group edit-row-right">
							<label>Khởi chiếu:</label> <input class="edit-row-text"
								type="date" name="dateOpen" id="startDay"  required ></input>
						</div>
						<div class="form-group edit-row-left">
							<label>Ngôn ngữ: </label> <select id="phude" name="language"   required>
					...
					<div class="form-group edit-row">
						<div class="form-group edit-row-left">
							<label>Phim: </label> <select id="phim" name="category"  required>
						...
						<div class="form-group edit-row-left">
							<label>Trailer: </label> <input class="edit-row-text" name="tralier" value="" type="text"  required></input>
						</div>
					...
					<div class="form-group footer">
						...
						<a href="${pageContext.request.contextPath}/admin/movie/show"><button class="delete" type="button">
							<i class="icon-md-lock">Trở lại</i>
						</button></a>
					</div>
				</div>
			</form>
